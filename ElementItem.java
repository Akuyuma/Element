...
public class ElementItem extends Element {
	...
	public void display() {
		...
		if (item != null && this.isHovered() && this.hoveredInformations) {
			...
			if(this.side) {
				...
				this.minecraft.currentScreen.func_146285_a(item, this.getPosX() - 5 - width, this.getPosY() + 20 + heightModifier - height);
			} else {
				this.minecraft.currentScreen.func_146285_a(item, this.getPosX()  + 25, this.getPosY() + 20);
			}
